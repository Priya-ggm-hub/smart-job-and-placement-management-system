    ...
    public CommandLineRunner initData(
        ...
        return args -> {
            try {
                ...
                } else if (studentUser.getPassword() == null || !passwordEncoder.matches("Password@123", studentUser.getPassword()) || !studentUser.isActive()) {
                ...
                if (studentRepository.findByUser(studentUser).isEmpty() && studentRepository.findByUserEmail(studentUser.getEmail()).isEmpty()) {
                ...
                for (String demoEmail : otherDemoAccounts) {
                    userRepository.findByEmail(demoEmail).ifPresent(u -> {
                        if (u.getPassword() == null || !passwordEncoder.matches("Password@123", u.getPassword())) {
